  ...
  private <T> Map<String, T> listByIds(
    ...
    try {
      ...
      if (idGetter != null) {
        ...
        com.wizzdi.asaf.runtime.security.UserSecurityContext securityContextPrincipal =
            (com.wizzdi.asaf.runtime.security.UserSecurityContext) securityContext.getPrincipal();
